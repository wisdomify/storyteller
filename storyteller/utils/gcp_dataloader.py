...
from storyteller.paths import BS_DIR, DS_DIR, SFC_DIR, KESS_DIR, KJ_DIR, KCSS_DIR, SFKE_DIR, KSNS_DIR, KC_DIR
...
if __name__ == '__main__':
    ...
    gcp_storage.download('story/elastic/한국어 대화', KC_DIR, unzip=True)
